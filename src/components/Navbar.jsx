...
                  {/*                     Se filtra dynamicCategories para mostrar solo aquellas
                    que tienen una ruta en CATEGORY_ROUTE_MAP.
                  */}
                  {dynamicCategories
                    .filter((cat) => CATEGORY_ROUTE_MAP[cat]) // <--- **FILTRO APLICADO AQUÍ**
                    .map((cat) => {
                      const route = CATEGORY_ROUTE_MAP[cat]; // Sabemos que 'route' existe por el filtro
                      return (
                        <li key={cat}>
...
                      );
                    })}
                  {/*                     También necesitamos ajustar la lógica de "Sin categorías"
                    para que se base en las categorías *filtradas*.
                  */}
                  {dynamicCategories.filter((cat) => CATEGORY_ROUTE_MAP[cat]).length === 0 && (
                    <li>
